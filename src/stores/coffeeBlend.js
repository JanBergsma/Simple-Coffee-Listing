...
export const usecoffeeBlendStore = defineStore('coffeeBlend', () => {
  const coffeeBlends = [
    {
      id: 1,
      name: 'Cappuccino',
  ...
  const availableBlends = computed(() => coffeeBlends.filter((cb) => cb.available))

  return { coffeeBlends, availableBlends }
})
